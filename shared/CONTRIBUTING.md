...
All ewoks projects follow the [NumPy AI Policy](https://numpy.org/doc/stable/dev/ai_policy.html).

In short:

0. Use of AI must be disclosed. Use the pull request template to describe which technology was used and for what part.
